...
const RecentBlogCart = ({item}: RecentBlogCartProps) => {
    return (
        <>
            <Row gutter={5}>
                <Col span={6}>
                    <img src="https://www.crunchlabs.com/cdn/shop/articles/CLBlog_Illustrations-7_1_7638b573-4dd3-4112-99eb-ae73fc15fd1f.png?v=1723840302" alt="" />
                </Col>
                <Col span={18} className=" items-center">
