        ...
        <TermsLayout>
            <div className='md:px-0 md:mx-10 px-6 relative'>
                <div className='w-full'>
                    ...
                    <p className='p_line_height mt-3'>
                        Thank you for joining Crunchlabs. We at Crunchlabs (
                        <strong>Crunchlabs”</strong>,
                        <strong>“we”</strong>,
                        <strong>“us”</strong>,
                    ...
                    <p className='p_line_height mt-3'>
                        ...
                        Unless we link to a different policy or state otherwise, this Privacy Policy applies when you visit or use Crunchlabs websites, mobile applications, APIs, or related services (the
                    ...
                    <div className='mt-3'>
                            ...
                            <table className={styles.policy_table}>
                                <tbody>
                                    ...
                                    <tr className={styles.policy_tr}>
                                        ...
                                        <td className={styles.table_description}>
                                            If you contact us for support or to report a problem or concern (regardless of whether you have created an account), we collect and store your contact information, messages, and other data about you like your name, email address, messages, location, Crunchlabs user ID, refund transaction IDs, and any other data you provide or that we collect through automated means (which we cover below). We use this data to respond to you and research your question or concern, in accordance with this Privacy Policy.
                                        </td>
                                        <td className={styles.table_description}>
                                            <ul>
                                                <li className={styles.list_content}>
                        ...
                        <p className='p_line_height mt-3'>
                            If you are a Crunchlabs Business enterprise or corporate prospect, in addition to information you submit to us, we may collect certain business contact information from third-party commercial sources.</p>
                        ...
                        <p className='p_line_height mt-3'>
                            We use cookies, which are small text files stored by your browser, to collect, store, and share data about your activities across websites, including on Crunchlabs. They allow us to remember things about your visits to Crunchlabs, like your preferred language, and to make the site easier to use. To learn more about cookies, visit
                        ...
                        <p className='p_line_height mt-3'>
                            Crunchlabs and service providers acting on our behalf (like Google Analytics and third-party advertisers) use server log files and automated data collection tools like cookies, tags, scripts, customized links, device or browser fingerprints, and web beacons (together,
                        ...
                        <p className='p_line_height mt-3'>
                            Crunchlabs uses the following types of Data Collection Tools for the purposes described:
                        </p>
                        ...
                        <div className={styles.alertBanner}>
                            <p className='p_line_height'>
                                We share certain data about you with instructors, other students, companies performing services for us, Crunchlabs affiliates, our business partners, analytics and data enrichment providers, your social media providers, companies helping us run promotions and surveys, and advertising companies who help us promote our Services. We may also share your data as needed for security, legal compliance, or as part of a corporate restructuring. Lastly, we can share data in other ways if it is aggregated or de-identified or if we get your consent.</p>
                        </div>
                        <ul style={{ listStyleType: 'disc', paddingLeft: "1.8rem" }}>
                            <li className={styles.policy_li}>
                                <u className={styles.policy_u}>With Your Instructors:</u> We share data that we have about you (except your email address) with instructors or teaching assistants for educational content you access or request information about, so they can improve their content for you and other students. This data may include things like your country, browser language, operating system, device settings, the site that brought you to Crunchlabs, and certain activities on Crunchlabs, like enrolled courses and course review. We will not share your email address with instructors or teaching assistants. (Account Data; System Data; Usage Data; Approximate Geographic Data)
                            </li>
                        ...
                        <h2 id='section5' className={`${styles.content} text-xl sm:text-2xl`}>5. Crunchlabs's rights to the content you post</h2>
                        <div className={styles.alertBanner}>
                            <p className='p_line_height'>
                        ...
                        <p className='p_line_height mt-3'>
                            Crunchlabs takes appropriate security measures to protect against unauthorized access, alteration, disclosure, or destruction of your personal data that we collect and store. These measures vary based on the type and sensitivity of the data. Unfortunately, however, no system can be 100% secured, so we cannot guarantee that communications between you and Crunchlabs, the Services, or any information provided to us in connection with the data we collect through the Services will be free from unauthorized access by third parties. Your password is an important part of our security system, and it is your responsibility to protect it. You should not share your password with any third party, and if you believe your password or account has been compromised, you should change it immediately and contact our
                        ...
                        <p className='p_line_height mt-3'>
                            ...
                            Parents who believe that Crunchlabs may have collected personal data from a child under those ages can submit a request that it be removed to
                            <a className={styles.link_to} href="mailto:Crunchlabs@gmail.com"> privacy@Crunchlabs.com</a>
                        </p>
                        ...
                        <p className='p_line_height mt-3'>
                            Any capitalized terms not defined in this policy are defined as specified in Crunchlabs's .
                        ...
                        <p className='p_line_height mt-3 mb-10'>
                            ...
                            <a href="mailto:Crunchlabs@gmail.com" className={styles.link_to}> Crunchlabs@.com</a>
                        </p>
                    </div>
                </div>
