		...
		<TermsLayout>
			<div className='md:px-0 md:mx-10 px-6 relative'>
				<div className='w-full'>
					...
					<p className='p_line_height mt-3'>
						<strong>IF YOU LIVE IN THE VIETNAM OR US, BY AGREEING TO THESE TERMS, YOU AGREE TO RESOLVE ALL DISPUTES WITH CRUNCHLABS IN SMALL CLAIMS COURT OR ONLY THROUGH BINDING INDIVIDUAL ARBITRATION AND YOU WAIVE YOUR RIGHT TO PARTICIPATE IN ANY CLASS ACTION AND WAIVE YOUR RIGHT TO A JURY DECISION, AS EXPLAINED IN THE DISPUTE RESOLUTION SECTION.</strong>
					</p>
					<div className='mt-3'>
						<p className='p_line_height'>CrunchLabs's mission is to improve lives through learning. We make it possible for anyone, anywhere, to create and share educational content (trainers) and access that educational content to learn (students). We consider this marketplace model to be the best way to deliver valuable educational content to users. We need rules to ensure our platform and services are safe for you, us, and our community of students and instructors. These Terms apply to all of your activities on the CrunchLabs website, the CrunchLabs mobile app, the TV app, our APIs, and other related services (
							<strong>"Service"</strong>
							)
						</p>
						<p className='p_line_height mt-4'>If you post a course on the CrunchLabs platform, you must also agree to Terms for Instructors. We also provide details about our processing of personal data of students and lecturers in Privacy policy of us</p>
						<p className='p_line_height mt-4'>Our website and applications cause communications about your web and application browsing activities and application usage to be sent from you to third parties that provide services to CrunchLabs. By using our Services, you agree to these communications.</p>
						...
						<div className={styles.alertBanner}>
							<p className='p_line_height'>You need an account for most activities on our platform. Please be sure to keep your password in a safe place, as you are responsible for all activities related to your account. If you suspect someone is using your account, please let us know by contacting Support Group ours. You must be of legal age to consent to online services in your country to use CrunchLabs.</p>
						</div>
						...
						<p className='p_line_height mt-3'>You may not share your account login information with anyone else. You are responsible for all activity on your account, and CrunchLabs will not intervene in disputes between students or instructors sharing account login information. You must notify us immediately upon learning that someone may be using your account without your permission.</p>

						<p className='p_line_height mt-3'>Students and instructors must be 18 years of age to create an account on CrunchLabs and use the Services. If you are under 18 but over the age required to consent to use online services where you live (for example, 13 in the US or 16 in Ireland), you cannot set up an account but We encourage you to ask a parent or guardian to open an account and help you access appropriate content. If you are not old enough to consent to the use of these online services, you may not create a CrunchLabs account. If we discover that you have created an account in violation of these rules, we will terminate your account.</p>


						<h2 id='section2' className={`${styles.categories} text-xl sm:text-2xl`}>2. Content Subscription and Lifetime Access</h2>
						<div className={styles.alertBanner}>
							<p className='p_line_height'>When you enroll in a course or other content, you receive a license from us to view that content through the CrunchLabs Services and not use it for any other purpose. Please do not attempt to transfer or resell the content in any way. We generally grant you a lifetime access license, unless we have to disable content for legal or policy reasons or for Subscription subscriptions.</p>
						</div>
						<p className='p_line_height mt-3'>Under our Instructor Terms, when instructors post content on CrunchLabs, they grant CrunchLabs a license to license the content to students, which means we have the right to sublicense the content to students. registered member. As a student, when you enroll in a course or other content, whether free or paid, you receive a license from CrunchLabs to view the content through the platform and Services. of CrunchLabs and CrunchLabs is the licensor. Content is licensed and not sold to you. This license does not grant you any rights to resell the content in any way (including by sharing account information with the purchaser or illegally downloading the content and sharing it on other platforms). torrent site.</p>

						<p className='p_line_height mt-3'>In fuller legal terms, CrunchLabs grants you (as a student) a limited, non-exclusive, non-transferable license to access and view the content for which you have paid all fees. required fees, solely for personal, non-commercial educational purposes through the Services, subject to these Terms and any conditions or restrictions regarding specific content or features of the Services ours. All other uses are expressly prohibited. You may not copy, redistribute, transmit, transfer, sell, broadcast, rent, share, lend, modify, adapt, edit, create derivative works, sublicense, transfer or use any content unless we expressly permit it in a written agreement signed by an authorized CrunchLabs representative. This also applies to content you can access through any of our APIs.</p>
						...
						<div className={styles.alertBanner}>
							<p className='p_line_height'>When paying, you agree to use a valid payment method. If you're not satisfied with the content, CrunchLabs offers a 30-day refund or offer on most content purchases.</p>
						</div>
						...
						<p className='p_line_height mt-3'>You agree to pay for the content you purchase and you authorize us to charge your debit or credit card or process such charges by other payment methods (such as Boleto, SEPA, direct debit or mobile wallet). CrunchLabs partners with payment service providers to offer you the most convenient payment methods in your country and to keep your payment information secure. We may update your payment method using information provided by our payment service provider.</p>

						<p className='p_line_height mt-3'>If the content you purchased is not what you expected, within 30 days of purchasing the content, you can request a refund from CrunchLabs to your account. This refund option does not apply to Subscription purchases, which are covered in Section 8.4 (Payment and Billing) below. We may, at our sole discretion, issue you a refund as a refund offer or a refund to your original payment method, subject to the capabilities of our payment service providers, the platform you purchased the content on (website, mobile app or TV) and other factors. You will not receive a refund if you submit a request after the 30-day guarantee period has expired. However, if content you previously purchased is disabled for legal or policy reasons, you are entitled to a refund after this 30-day limit. CrunchLabs also reserves the right to refund students after the 30-day period in the event of suspected or confirmed account fraud.</p>

						<p className='p_line_height mt-3'>CrunchLabs or our partners may offer promotional codes and gifts to students. Some codes can be redeemed for gifts or promotional offers applicable to your CrunchLabs account, which can then be used to eligible purchase content on our platform, subject to our terms and conditions. clause that acccompanies that code. Other codes can be redeemed directly for specific content. You cannot use gift and promotional offers to make purchases in our mobile or TV apps.</p>

						<h2 id='section4' className={`${styles.categories} text-xl sm:text-2xl`}>4. Content and behavior rules</h2>
						<div className={styles.alertBanner}>
							<p className='p_line_height'>You may only use CrunchLabs for lawful purposes. You are responsible for all content you post on our platform. You should ensure that the reviews, questions, posts, courses and other content you upload comply with our Trust & Safety Guidelines and the law, and respect intellectual property rights. wisdom of others. We may ban your account for repeated or serious violations. Please notify us if you believe someone is violating your copyright on our platform.</p>
						</div>
						...
						<h2 id='section5' className={`${styles.categories} text-xl sm:text-2xl`}>5. CrunchLabs's rights to the content you post</h2>
						<div className={styles.alertBanner}>
						...
						<h2 id='section7' className={`${styles.categories} text-xl sm:text-2xl`}>7. CrunchLabs Permissions</h2>
						<div className={styles.alertBanner}>
							<p className='p_line_height'>We own the CrunchLabs platform and Services, including the website, current or future applications and services, and things like logos, APIs, code, and content created by our employees. You may not tamper with them or use them without permission.</p>
						</div>

						<p className='p_line_height mt-3'>All rights, title and interest in and to the CrunchLabs platform and Services, including current or future websites, applications, APIs, databases and content that its employees or Our partners submit or make available through our Services (but excluding content provided by instructors and students) are and will remain the exclusive property of CrunchLabs and its licensors. CrunchLabs. Our platforms and services are protected by copyright, trademark, and other laws of both the United States and foreign countries. There are no rights granted to you to use the CrunchLabs name or any CrunchLabs trademarks, logos, domain names, and other distinctive brand features. Any feedback, comments or suggestions you may provide regarding CrunchLabs or the Services are entirely voluntary and we will be free to use such feedback, comments or suggestions as we see fit and without have any obligations to you.</p>
						...
						<p className='p_line_height mt-3'>You can start your subscription with a free trial. The free trial period for your subscription will be indicated during the registration process. CrunchLabs determines free trial eligibility at our sole discretion and may limit access, eligibility, or free trial length. We reserve the right to terminate your free trial period and suspend your subscription if we determine that you are not eligible.</p>
						...
						<p className='p_line_height mt-3'>You agree that by registering for, accessing, or using our Services, you are entering into a legally binding contract with CrunchLabs. If you do not agree to these Terms, please do not register for, access or use any of our Services.</p>
						...
						<p className='p_line_height mt-3'>CrunchLabs commits to making every effort to resolve disputes with CrunchLabs users without filing a formal legal complaint. If a problem arises between the two parties, you and CrunchLabs agree to first work diligently and in good faith to reach a solution that is fair and equitable to both parties using the dispute resolution process Not officially required are described below. Sometimes, a third party may be necessary to help resolve a dispute between two parties. This dispute resolution agreement limits how these disputes will be resolved.</p>

						<p className='p_line_height mt-3'>
							<strong>YOU AND CrunchLabs AGREE THAT ANY AND ALL DISPUTES, CLAIMS OR CONTROVERSIES ARISING OUT OF OR RELATING TO THESE TERMS OR THEIR APPLICABILITY, BREACH, TERMINATION, VALIDITY, ENFORCEMENT OR DISSOLUTION LIKE THEM OR THE USE OF THE SERVICES OR COMMUNICATIONS WITH CrunchLabs (COLLECTIVELY, “DISPUTES”) THAT ARE NOT INFORMALLY RESOLVED MUST BE RESOLVED EXCLUSIVELY IN A SMALL CLAIMS COURT OR THROUGH BINDING INDIVIDUAL ARBITRATION AND AGREE TO WAIVE THE RIGHT TO A JURY TRIAL AND TO FILE A CLAIM IN ANY OTHER COURT.</strong>
						</p>

						<p className='p_line_height mt-3'>You and CrunchLabs agree that this Dispute Resolution Agreement applies to each party as well as all of their respective agents, attorneys, contractors, subcontractors, service providers, employees, and all others representing or on behalf of you and CrunchLabs. This dispute resolution agreement is binding on your and CrunchLabs's respective heirs, successors, and assigns, and is governed by the Federal Arbitration Act.</p>
